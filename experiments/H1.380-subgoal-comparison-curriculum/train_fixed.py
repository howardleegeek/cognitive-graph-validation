"""
H1.380 Experiment: Compare 2 vs 3 Subgoals Directly (Simplified)
...
Prediction: 2 subgoals will outperform 3 subgoals on 4-step tasks.

Key tests:
1. Direct comparison: 2 subgoals vs 3 subgoals on 4-step tasks
2. Compare Cognitive Graph vs Hierarchical Planner
"""
...
class HierarchicalPlanner(nn.Module):
    ...
    def __init__(self, obj_dim: int = 8, inst_dim: int = 32, hidden_dim: int = 128, 
                 n_subgoals: int = 2, subgoal_dim: int = 8):
        super().__init__()
        self.n_subgoals = n_subgoals
...
def main():
    """Run H1.380 experiment: Compare 2 vs 3 subgoals directly."""
    print("=== H1.380: Compare 2 vs 3 Subgoals Directly ===")
    ...
    hierarchical_2sub = HierarchicalPlanner(n_subgoals=2)
    ...
    hierarchical_3sub = HierarchicalPlanner(n_subgoals=3)
    ...
    cg_2sub = CognitiveGraphHierarchical(n_subgoals=2)
    ...
    cg_3sub = CognitiveGraphHierarchical(n_subgoals=3)
    ...
    results['hierarchical_subgoal_2_vs_3'] = results['hierarchical_2sub_improvement'] - results['hierarchical_3sub_improvement']
    ...
    print(f"\n2 subgoals vs 3 subgoals (CG): {results['subgoal_2_vs_3']:.2f}% (positive favors 2 subgoals)")
    print(f"2 subgoals vs 3 subgoals (Hierarchical): {results['hierarchical_subgoal_2_vs_3']:.2f}% (positive favors 2 subgoals)")
    ...
    with open("results/results.json", "w") as f:
        json.dump({
            ...
            "description": "Compare 2 vs 3 Subgoals Directly",
            "config": {
                "n_steps": 4,
            ...
            "key_finding": f"Best configuration: {best_cg_config} with {best_cg_improvement:.2f}% improvement. 2 subgoals vs 3 (CG): {results['subgoal_2_vs_3']:.2f}%. 2 subgoals vs 3 (Hierarchical): {results['hierarchical_subgoal_2_vs_3']:.2f}%."
        }, f, indent=2)
