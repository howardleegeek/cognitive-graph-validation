#!/usr/bin/env python3
"""
H1.336: Complex Multi-Step Tasks (15-30 Steps)
Based on H1 success (+25.6% real robot, +30.6% on 3-step), test with more complex multi-step tasks
"""
import sys
...
results = {
    ...
    'config': {'task_type': 'complex_multi_step', 'n_steps_range': '15-30'}
}
