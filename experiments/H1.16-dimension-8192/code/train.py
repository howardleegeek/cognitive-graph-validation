"""
H1.16: Test 8192 dimensions
Continue dimension scaling beyond 4096 to find plateau.
"""
import numpy as np
import json
...
def run_experiment():
    ...
    results = {}
    for dim, name in [(256, "256"), (512, "512"), (1024, "1024"), (2048, "2048"), (4096, "4096"), (8192, "8192")]:
        print(f"Training {name}-dim model...")
        model = MLPRegressor(
