...
print(f"Seq=450: Attn={attn_loss:.4f}, Concat={concat_loss:.4f}, Δ={delta:+.1f}%")
print(f"{'SUPPORTED' if delta > 0 else 'REFUTED'}")

with open("results.json", "w") as f:
    json.dump({"seq_len": 450, "attn": attn_loss, "concat": concat_loss, "delta": delta}, f, indent=2)