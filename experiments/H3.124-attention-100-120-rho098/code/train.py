#!/usr/bin/env python3
"""H3.124: Attention on 100-120 steps with maximum autocorrelation (rho=0.98)

Pushing to the limit - can attention work on 100+ step sequences?
"""
...
print("H3.124: Attention on 100-120 Steps with Maximum Autocorrelation (rho=0.98)")
print("=" * 70)

rho = 0.98
seq_lengths = [100, 105, 110, 115, 120]
results = {"hypothesis": "H3.124", "rho": rho, "timestamp": datetime.now().isoformat(), "experiments": []}
...
import os
os.makedirs("experiments/H3.124-attention-100-120-rho098/results", exist_ok=True)
with open("experiments/H3.124-attention-100-120-rho098/results/metrics.json", "w") as f:
